...
exports.DEMO_TEAM_FINANCIAL_SUMMARY = exports.DEMO_PLAYERS_WITH_CONTRACTS = exports.DEMO_CONTRACTS = exports.DEMO_PLAYERS = exports.DEMO_TEAMS = exports.DEMO_LEAGUES = exports.DEMO_USER = void 0;
...
function getDemoPlayersWithContracts(teamId) {
    if (teamId) {
        return exports.DEMO_PLAYERS_WITH_CONTRACTS.filter(player => player.contract && player.contract.teamId === teamId);
    }
