    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Fantasy Contract Manager</h1>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-left">
                <h3 className="font-semibold text-gray-800 mb-2">Gerenciamento de Contratos</h3>
                <p className="text-gray-600 text-sm">
                  Contratos de 1-4 anos com aumentos automáticos de 15% por temporada
                </p>
              </div>
              <div className="text-left">
                <h3 className="font-semibold text-gray-800 mb-2">Salary Cap</h3>
                <p className="text-gray-600 text-sm">
                  Controle total do teto salarial com alertas e projeções
                </p>
              </div>
              <div className="text-left">
                <h3 className="font-semibold text-gray-800 mb-2">Franchise Tags</h3>
                <p className="text-gray-600 text-sm">
                  Sistema de tags para reter jogadores por mais uma temporada
                </p>
              </div>
              <div className="text-left">
                <h3 className="font-semibold text-gray-800 mb-2">Dead Money</h3>
                <p className="text-gray-600 text-sm">
                  Cálculo automático de dead money ao cortar jogadores
                </p>
              </div>
              <div className="text-left">
                <h3 className="font-semibold text-gray-800 mb-2">Rookie Draft</h3>
                <p className="text-gray-600 text-sm">
                  Contratos automáticos para rookies com opção de 4º ano
                </p>
              </div>
              <div className="text-left">
                <h3 className="font-semibold text-gray-800 mb-2">Integração Sleeper</h3>
                <p className="text-gray-600 text-sm">
