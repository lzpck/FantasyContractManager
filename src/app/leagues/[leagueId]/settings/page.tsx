    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-400 mb-4">A liga solicitada não foi encontrada ou você não tem acesso a ela.</p>
          <button
          ...
          <div className="bg-yellow-900/20 border border-yellow-700/30 rounded-lg p-4 mb-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-100">Apenas o comissário da liga pode alterar essas configurações.</p>
              </div>
            </div>
          </div>
        )}
            ...
            {error && (
              <div className="bg-red-900/20 border border-red-700/30 rounded-lg p-4 mb-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-red-200">Erro ao carregar configuração</h3>
        ...
        {activeTab === 'general' && (
          <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">Nome da Liga</label>
              ...
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">Máximo de Franchise Tags</label>
                <div className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-300">
                  {league.maxFranchiseTags}
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">Aumento Anual (%)</label>
                <div className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-300">
                  {league.annualIncreasePercentage}%
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">Salário Mínimo</label>
                <div className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-300">
                  ${league.minimumSalary.toLocaleString()}
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">Data de Virada de Temporada</label>
                <div className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-slate-300">
            ...
            <div className="mt-6 p-4 bg-blue-900/20 border border-blue-700/30 rounded-lg">
              ...
              <p className="text-sm text-blue-100">
                Para alterar as configurações gerais da liga, use o modal de edição na página principal das ligas.
              </p>
            </div>
          </div>
        )}
