            ...
            {playersWithContracts.map(playerWithContract => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-100">
                  {playerWithContract.contract ? formatCurrency(playerWithContract.contract.currentSalary) : 'N/A'}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-100">
                  {playerWithContract.contract ? `${playerWithContract.contract.yearsRemaining} ano(s)` : 'N/A'}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-100">
                  {playerWithContract.contract ? playerWithContract.contract.acquisitionType : 'N/A'}
                </td>
                {canManage && (
